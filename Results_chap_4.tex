...
In the study, the presence of secondary reaction products following the liberation of the nitrate group was observed in the \ac{UVVIS} absorption spectra. Samples with longer ageing time presented spectra dominated by consecutive products. Though figure \ref{fig:SB59_NOx} illustrates the reaction of the dye with NO groups, the study makes no indication of the source of NO\textsubscript{x}, except that they are products of thermolysis of \ac{NC}. %Whether these are 
...
\toprule
\multirow{2}{*}{}& \multirow{2}{*}{\ce{CH3CH2ONO2 + H3O+ <-> CH3CH2ONO2H+ + H2O}} & \multicolumn{2}{c}{$\Delta$G\textsubscript{r}} & \multicolumn{2}{c}{$\Delta$H\textsubscript{r} }\cline{3-6} \\
