...
When studying the ageing of \ac{NC} using  ultraviolet–visible spectroscopy, Moniruzzaman \textit{et al.} observed %identified 
...
The reaction of the 1,4-bis(ethylamino)-9,10-anthraquinone (\ac{SB59}) with NO\textsubscript{x} released by denitration, mimics the action of stabilisers such as \ac{DPA} and \ac{2NDPA} commonly used in \ac{NC} formulations (figure \ref{fig:anthraquinone_SB59}). %REF 
...
In their work looking into the atmospheric reactions of methynitrate and methylperoxy nitrate Arenas suggested it was possible for the homolytic denitration reaction of methynitrate to share a common peroxy intermediate with the peroxide \cite{Arenas2007}. This could account for some of the lower order NO\textsubscript{x} generated. %(just \ce{^{.}NO}, tbh, or maybe perhaps how NO3 may get generated?).
%Baker1950
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
In this section, secondary and extended reaction schemes for the low temperature ageing of \ac{NC} are explored. Decomposition pathways defined by Chin, Camera and Aellig \textit{et al.} are probed to determine the reactions responsible for the experimentally observed degradation products. 
...
\ce{4HNO3 <=> 4^{.}NO2 + 2H2O + O2}&53.35029&58.36446&42.60942&46.93563\\
...
The \ac{wb97xd} values obtained for the formation of \ce{N2O4} from 2\rad\ce{NO2} are in good agreement with the experimentally recorded value of -1.4 kcal mol$^{-1}$ \cite{Awasthi2013,Roscoe1993}. %CCSD(T) calculated
