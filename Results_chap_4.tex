...
\ce{R-O^{.} + ^{.}NO2 ->[\ce{R-ONO2}]} & \ce{ R-ONO2 + ^{.}NO + N2O4 + ^{.}NO2}\\
								& \ce{ + H2O  + N2O + CO2 + CO } \\
								& \ce{+ C2H2O +} \text{other organic fragments}
%\end{multline}
\end{split}
...
The hydrolysis equations were modified from an earlier work by Camera \textit{et al.}, where the scheme was presented with ethyl nitrate (where R = \ce{CH3CH2} for the scheme above) \cite{Camera1982}:
...
The oxidation of alchol by nitric acid (equation \ref{equ:chinH2}) is slow, thus rate-limiting, and likely to occur \textit{via} a series of intermediate reactions where the mechanism is not known.  Following the generation of nitrous acid, subsequent oxidations occur rapidly. Equations \ref{equ:chinH3} - \ref{equ:chinH6} describe a possible branched radical chain mechanism, fed by the nitrous and nitric acids produced during the hydrolysis and alchohol oxidation reactions during the initiation stages. 
The reactions in the branched radical chain mechanism for thermomlysis are poorly characterised, only defined by the observable products.
...
Termination reactions were not emaphised in the schemes, for these cases. 

Aellig \textit{et al.} presented an alternative scheme when determining the decomposition of benzyl nitrate (\ce{PhCH2ONO2}, R = \ce{PhCH2}), involving more interaction with the solvent  \cite{Aellig2012}:\\
...
However, for the initiation reactions Aellig prescribes the use of an amberlyst catalyst,
The propagation reactions are acid catalysed by\ce{HNO2}. 

Both the Camera/Chin and Aellig schemes above produce final end products observed in the decomposition of \ac{NC}. In particular, Aeelig’s scheme accounts for the production of \ce{N2O}, which forms a XXXX part of the decomposition eluent. 
...
\schemestart
%% Worked example
%%\chemfig{A}\arrow(aa--bb)[-30,1.5]\chemfig{B}
%%\arrow(@aa--cc)[-150,1.5]\chemfig{C}
%%\arrow(cc--dd){0}[-90,0]\chemfig{D}
%%
%%This seems to give the same results
%%A\arrow(aa--bb)[-30,1.5]B
%%\arrow(@aa--cc)[-150,1.5]C
%%\arrow(cc--dd){0}[-90,0]D
%
%\ce{R - O^{.} + ^{.}NO2}\arrow(aa--bb)[0,1]\ce{R - O^{.}} havoc
%\arrow(@aa--cc)[-90,1]\ce{2^{.}NO2 + H2O <=> N2O4 + H2O}
%\arrow(cc--dd){0}[-90,0.1]\ce{R-OH + ^{.}NO2 -> ^{.}R-OH + HNO2}
%\arrow(dd--ee)[-150]\ce{N2O4 + H2O -> HNO3 + HNO2}
%\arrow(@dd--ff)[-15,2]\ce{^{.}R-OH + HNO3 -> R=O + H2O + ^{.}NO2}
%\arrow(@ee--gg)[-90,1]\ce{HNO2 + R-OH <=> R-ONO + H2O}
%\arrow(gg--hh)[-90,1]\ce{R-OH + HNO3 -> R=O + HNO2 + H2O}
%\arrow(hh--ii){0}[-90,0.1]\ce{HNO3 + HNO2 <=> N2O4 + H2O} 
%\arrow(@gg--jj)\ce{R-ONO -> R=O + HNO}
%\arrow(jj--kk)[-90,1]\ce{2HNO -> HON=NOH}
%\arrow(kk--ll){0}[-90,0.1]\ce{^{.}NO2 + HNO -> HNO2 + ^{.}NO}
%\arrow(kk--ll)[-90,1]\ce{2 ^{.}NO + O2 -> 2 ^{.}NO2}
% No colours
...
\schemestop 
\caption{Proposed degradation pathway starting from the homolysis products of a nitrate ester, derived from the schemes presented by Camera \cite{Camera1982} and Aellig\cite{2011}.}
\end{scheme}
...
\arrow(@aa--bb)[-150,2]\ce{R-OH + HNO2 <=> R-ONO + H2O}
\arrow(bb--cc)[-90]\ce{R-ONO -> R=O + HNO}
\arrow(cc--dd)[-90]\ce{2HNO -> HON=NOH}
\arrow(dd--ee)[-90]\ce{HON=NOH -> N2O + H2O}
\arrow(@aa--ff)[-30,2]\ce{R=O}
\schemestop 
\caption{Proposed degradation pathway starting from the elimination of \ce{HNO2} from a nitrate ester, derived from the schemes presented by Camera \cite{Camera1982} and Aellig\cite{2011}.}
\end{scheme}
...
\arrow(@aa--bb)[-135,2]\ce{NO2+ + 2H2O <=> HNO3 + H3O+}
%\merge>(@aa--@bb)
%\arrow(@aa--cc)[-30,2]\ce{R-OH + HNO3 -> R=O + HNO2 + H2O}
\arrow(@bb--cc)\ce{HNO3 + R-OH -> R=O + HNO2 + H2O}
\arrow(@bb--dd)[-90]\ce{HNO3 + HNO2 <=> N2O4 + H2O} 
\arrow(@cc--@dd)
\arrow(dd--ee)[-20,3]\ce{HNO2 + R-OH <=> R-ONO + H2O}
\arrow(@dd--ff)[-90]\ce{N2O4 + H2O -> HNO3 + HNO2}
\arrow(ff--gg){0}[-90,0.2]\ce{N2O4 <=> 2^{.}NO2}
\arrow(@ee--hh)[-90]\ce{R-ONO -> R=O + HNO}
\arrow(hh--ii)[-90]\ce{2HNO -> HON=NOH}
\arrow(ii--jj)[-90]\ce{HON=NOH -> N2O + H2O}
\schemestop 
\caption{Proposed degradation pathway starting from the acid hydrolysis of a nitrate ester, derived from the schemes presented by Camera \cite{Camera1982} and Aellig\cite{2011}.}
\end{scheme}

\begin{table}[htp]
\begin{center}
\caption{Energies of nitrate ester decomposition reactions proposed by Camera \cite{Camera1982}, Chin \cite{Chin2007} and Aellig \cite{2012}. R = \ce{CH3CH2} for ethyl nitrate, and R = \ce{H3C-O-C6H9O3s-OCH3} (bi-methoxy capped glucopyraonse monomer unit).}
\begin{tabular} { l *{4}{S[table-format = 2.4]}} 
\toprule
...
\ce{2^{.}NO + O2 -> 2^{.}NO2} \\
\ce{2^{.}NO2 <=> N2O4}\\
\ce{R-ONO2 + H2O -> R-OH + HNO3}	&	4.556160	&	5.235930	&	4.000500	&	4.860450 \\
...
\ce{N2O4 <=> 2^{.}NO2}	&	-0.702450	&	0.930510	&	-1.359540	&	-0.155610 \\
...
\ce{R-OH + HNO3 -> R=O + HNO2 + H2O} &	-36.72522&	-38.34306	&	-41.71419	&	-41.70411 \\
\ce{R-OH + ^{.}NO2 -> ^{.}R-OH + HNO2}	&	14.71302	&	11.15163	&	13.03407	&	23.20983 \\
\ce{^{.}R-OH + HNO3 -> R=O + H2O + ^{.}NO2}	&	-212.2848	&	-204.2638	&	-225.9452	&	-267.8988 \\
