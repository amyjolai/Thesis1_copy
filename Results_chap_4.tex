...
) involving the nitrate ester decomposition and subsequent reactions of ethyl nitrate (where R = \ce{CH3CH2} for the scheme above) \cite{Camera1982}. The original study included an expansion of the hydrolysis step (equation {equ:protonation}, ), where the involvement of \ce{NO2+} was illustrated (scheme \ref{sch:cameraschema_full}%, first seen in section \ref{chapter5:intro})% is repeated below}.  \\ %pertaining to ethyl nitrate:
...
In their work looking into the atmospheric reactions methyl nitrate methylperoxy nitrate Arenas (2007) suggested it was possible for the homolytic denitration reaction of methyl nitrate to share a common peroxy intermediate with the peroxide. This could account for some of the different/lower order NO\textsubscript{x} generated (just \ce{^{.}NO}, tbh, or maybe perhaps how NO3 may get generated?).
%Baker1950
...
Simplified schemes for the ageing reactions of \ac{NC} beginning from homolytic fission, elimination of \ce{HNO2} or acid hydrolysis are illustrated in schemes \ref{sch:homolytic} - \ref{sch:hydrolysis}. 
...
\ce{^{.}NO2} and \ce{HNO2} were consumed and regenerated, supporting the theory that these may be species contributing to the observed autocatalytic rate of decomposition, following a first-order rate induction period \cite{Rodger1963,Lindblom2002,Volltrauer1981}. For all schemes, \ce{R=O} and \ce{N2O} were terminating species, which may go on to participate in wider reactions outside the scope of the proposed reactions. %why are they terminating species? - they do not go on to react and regenerate HNO2 and .NO2?
Table \ref{tab:post_energies} shows the energies for the reactions in all schemes, for both ethyl nitrate and the \ac{NC} monomer. 
...
\section{Summary}
Map of the possible reactions, linking to 
