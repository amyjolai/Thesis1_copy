...
\acro{CH3OH} [\ce{CH3OH}]{NC repeat unit with methoxy capping group on ring 1, hydroxy group on ring 2}
...
\acro{OHCH3}[\ce{OHCH3}]{NC repeat unit with hydroxy capping group on ring 1, methoxy group on ring 2}
