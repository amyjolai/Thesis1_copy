...
\acro{CH3CH3} {NC repeat unit with two methoxy capping groups}
\acro{CH3OH} {NC repeat unit with a methoxy capping group on ring 1, hydroxy capping on ring 2}
...
\acro{OHCH3} {NC repeat unit with hydroxy capping group on ring 1, methoxy capping group on ring 2}
