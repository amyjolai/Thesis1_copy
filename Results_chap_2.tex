...
\begin{figure}[ht!]
  \centering
	\includegraphics[width=0.25\linewidth]{anthraquinone_SB59}
...
Following reaction with NO\textsubscript{x} species, the dye shifts UV absorption region, indicating the extent of denitration and the presence of secondary reaction products.}
...
The findings contrast with the work of Shukla \textit{et al.} which determined that denitration via alkyaline hydrolysis followed the order of C3$\rightarrow$C6$\rightarrow$C2 \cite{Shukla2012,Shukla2012a}. However, Shukla's study considered only the fully nitrated system. There is evidence that nitration and denitration is influenced by the presence of nitrate groups at adjacent positions. Matveev \textit{et al.} demonstrated that for polynitro esters the rate of liquid-phase decomposition did not increase linearly with number of nitrate reaction centres\cite{Matveev2003}. It was suggested that the increase in reactivity was due to the inductive effect of the nitrate groups. 
The inductive effect arises when a difference in the electronegativity of atoms connected by a $\textsigma$-bond causes a polarisation in the bond. Electron donating groups push electron density away from the donating group, increasing the $\textdelta$- partial charge on neighbouring atoms, and electron withdrawing groups pulling electron density towards the withdrawing group, generating a $\textdelta$+ charge on neighbouring atoms. %pushing electron density towards the  %HOW DOES THIS LINK WITH DESHIELDLING - NMR shifts
The characteristic step-wise removal of nitrate groups was also attributed to this property.  
