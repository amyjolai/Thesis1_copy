...
\end{itemize}
Meta-\ac{GGA} employs further parameterisation of the exchange-correlation functional; the laplacian (second derivative) of the electron density, $nabla^2$, is included as an additional degree of freedom. %Or loacl kinetic energy density. 
These have made improvements on \ac{LDA} and \ac{GGA} performance, but has not seen as popular use as the efficient hybrid \ac{DFT} functionals.%-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
\subsection{Hybrid functionals} 
%Self interaction error!
The exchange contribution to $E_{XC}$ is significantly larger than that of correlation. 
...
This assists to counteract the self-interaction problem, a significant source of error in most approximate exchange-correlation functionals for Kohn-Sham \ac{DFT} calculations. This spurious interaction of an electron with itself does not appear in \ac{HF} as  \cite{Bao2018}. 

The most widely used functional of this category, is undoubtedly the \ac{B3LYP}. 	
