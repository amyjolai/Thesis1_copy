...
\end{equation}
%
Thus, the Schr\"{o}dinger’s equation, dependent only on the electronic coordinates, is as follows: 
%
\begin{equation}
...
where the electronic coordinates are given by $\mathbf{q}_{i}$, the fixed nuclear positions by $\mathbf{q}_{k}$ and 
...
Calculation of $E_{el}$ for all possible nuclear coordinates allows the construction of a \ac{PES}. 
