...
% Uncomment to use.
%Can't seem to use this with local compiler (Miktex) 
%Make sure it's commented with local compile, otherwise will get error message and crash. 
%\renewcommand{\cite}[1]{\emph{\textsuperscript{[#1]}}}

% At last, content! Remember filenames are case-sensitive and 
%  *must not* include spaces.
%\include{List-of-all}
\include{Preamble-impact}
\include{Abbreviations}
%\include{Introduction}
%\include{Theory}
%\include{Results_chap_1}
%%%\include{Results_chap_2}
%\include{Results_chap_3}
%\include{Results_chap_4}
%\include{Conclusions}
%\include{Appendices} 
%\include{Quotes} 
...
%CONVERSION FACTORS:  (note, these are from wiki.... but reinforced by https://cccbdb.nist.gov/hartreex.asp)
% H to kJ/mol: 			2625.4996
% H to kCal/mol: 			627.5095
% kJ/mol to kCal/mol:	4.183999764

% Present all data as 2 dp
% Exceptions may exist when presenting the raw hartree energies 
