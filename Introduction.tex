...
Each monomeric repeat unit in the chain has three hydroxyl groups that form hydrogen bonds. In ordered regions of the cellulose matrix, the hydrogen bonds allow the chains to arrange in a sheet or XXX structures, as in figure X. %cutout of cellulose beta sheet or alpha sheets, and other crystallographically significant hydrogen bonding patterns - add another sentence or more. 
