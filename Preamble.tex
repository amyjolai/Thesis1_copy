...
- \ac{NC} has been used in many products and its important to know how they are ageing 
...
- table of the property/sector vs benefit. (See Tab. 1)

\begin{table}[h!]
%  \begin{center}
    \caption{Benefits of knowledge about \ac{NC} ageing reactions}
    \label{tab:table1}
%    \begin{tabular}{l|r} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
    \begin{tabular}{|p{5cm}|p{10cm}|}
    \hline
      \textbf{Use} & \textbf{Benefit}\\
      \hline
