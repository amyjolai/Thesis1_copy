...
- NO2 leaving, with relaxation of NO2 internal angle ((protonated at bridging site - but really the capping site)floppy_HO-N-scan and (not protonated)floppy_NO2-C2-scan). Despite scanning over 4\AA and using an unrestricted method, the energy just kept rising and NO2 didn't break off.  (uwb97xd)
