...
\caption{Removal of nitrate group \texit{via} homolytic fission of \ac{NC}}
\label{fig:homofiss
\end{figure}
...
\caption{Removal of nitrate group \texit{via} elminiation of \ce{HNO2} of \ac{NC}}
\label{fig:homofiss
\end{figure}
