...
The most thermodynamically favoured protonation sites in the gaseous phase are at the terminal (upper) and capping positions. %The energy of each of the protonated species is identical. 
...
This is in contrast to the solvent phase, where the protonated nitrate group is rotated perpendicularly to the ring and the proton remains on the terminal Ot. %,  the solvent presents stabilisation for the protonated Ox. 
...
%It can be seen that the bridging and capping values show good agreement, in both \ac{wb97xd} and \ac{B3LYP} methods.  
...
Evaluation of the energy of protonation at each site found that the bridging and capping oxygens the most likely sites. However, all possible structures will be explored for the subsequent denitration stage.  \\
