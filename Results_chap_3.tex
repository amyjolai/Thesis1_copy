...
Rigid scans were carried out by fixing bond lengths, angles and dihedral values as constants. Only the variable of interest was allowed to change, %evolved
with the exception of  relaxation of other specified coordinates required for accommodation of the new geometry, following each step of the scan.  %(semi-rigid scans). 
