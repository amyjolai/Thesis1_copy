...
\caption{The attempted geometry of single water coordination to the \ac{NC} monomer.}
\end{figure}
...
\caption{At separation of over 3.3 \AA, the C2 \textendash C3 bond breaks leading to ring fission. The proton then moves back onto \ce{NO2} .}
\end{subfigure}
