...
The first stage of thermolytic decomposition for nitrate esters is widely considered to be homolytic fission of the O-N bond linking the nitrate to the alkyl chain, leading to the loss of \ce{^{.}NO2} (equation \ref{equ:homofiss}) \cite{Oxley2003} %many refs
...
The presence of \ce{^{.}NO2} and \ce{HNO2} were previously linked to autocatalytic rates observed for later-stage decomposition \cite{Rodger1963,Lindblom2002,Volltrauer1981}. %avanced stage decomp?
...
Inspection of the forces showed that they were in fact not converged. It was anticipated that the given geometries matched those used to generate the reaction energy values quoted in the study. The unconverged structures therefore do not fully explain the large discrepancy between the literature energies and obtained values here, though a possible explanation may be that different geometries were used for the values presented in the study. A small contribution may arise from a different compilation of the \ac{G09} program, leading to fluctuations in the exact values obtained which are amplified when deriving reaction energies. 
...
$^b$ values for the activation energy and total energy of reaction are the same when treating homolytic fission as a barrierless process. 
\end{table}

\begin{figure}[hbp]
\centering
\includegraphics[width=0.3\linewidth]{homolysis_arrow}
\caption{The \ce{O-NO2} bond was elongated during rigid and relaxed \ac{PES} scans simulating homolytic fission.}
\end{figure}

A \ac{PES} scan of \ce{NO2} leaving the \ac{NC} monomer 
...
\end{figure}
%
The mechanism of protonation was not explored in depth here; it was assumed that the protons in the system would be in fast exchange between the molecule and the solvent. The process has been studied computationally by Jebber \textit{et al.} \cite{Jebber1996}. 
...
\centering
\includegraphics[width=0.2\linewidth]{EN_NO2_leave_prot_step1-BL}
\end{subfigure}
\begin{subfigure}[b]{\linewidth}
\centering
\includegraphics[width=0.2\linewidth]{EN_NO2_leave_prot_step7-BL}
\end{subfigure}
\begin{subfigure}[b]{\linewidth}
\centering
\includegraphics[width=0.2\linewidth]{EN_NO2_leave_prot_step11-BL}
\end{subfigure}
\begin{subfigure}[b]{\linewidth}
\centering
\includegraphics[width=0.2\linewidth]{EN_NO2_leave_prot_step_cont5-BL}
\end{subfigure}
\end{figure}
%
...
\caption{4-membered ring transition state with protonation at the bridging nitrate oxygen site.}
\label{fig:4mem_b}
\end{subfigure}\\
%
\begin{subfigure}[b]{0.3\linewidth}
\caption{6-membered ring transition state with protonation at the terminal nitrate oxygen.}
\centering
...
\caption{6-membered ring transition state with protonation at the bridging nitrate oxygen site.}
\end{subfigure}\\
%
\begin{subfigure}[b]{0.3\linewidth}
\caption{6-membered ring transition state without prior protonation, under neutral hydrolysis condition.}
\centering
...
\caption{6-membered ring transition state with concerted protonation-denitration, under acid hydrolysis conditions.}
\end{subfigure}
\caption{Proposed transition states for the denitration of a nitrate ester, under various hydrolytic conditions. R = \ce{CH3} in the case of methyl nitrate, R = \ce{CH2CH3} in the case of ethyl nitrate and R = \ce{(H3CO)2C6H9O3} for the monomer.}
\end{figure}
%
...
\section{Summary}
Homolysis is fastest, for the monomer too, with HNO2 coming in second due to slower rate / energetics.
AH was not able to be comapared as a TS was not 
