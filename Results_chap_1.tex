...
In addition to environmental factors and contaminants, the degradation properties of \ac{NC} depend on the %\deleted{ primary, secondary and tertiary} 
polymer chain structure\added{,}
%{. These properties are}
 largely defined by the cellulose feedstock (figure \ref{fig:fibre}). 
...
\caption{Scanning electron micrograph (\acs{SEM}) images of \textbf{a)} Miscanthus cellulose and \textbf{b)} Miscanthus nitrocellulose, after nitration. From the work of Gismatulina \textit{et al.}\cite{Gismatulina2018}. \added{Reproduced with permission from the authors.} }
...
\includegraphics[scale=0.8]{Shukla_11224_2012_9977_Fig1_HTML}\quad
...
The properties of all capping group combinations and their effects on the dimer molecule were compared. %The hydroxyl capping group has demonstrated wide usage in literature when modelling carbohydrates, as . %REF and validate your next sentence. What other similar systems has it been used on?
It was expected that the smaller atomic radius of the hydroxyl capping group hydrogen would not significantly distort the wider structure of the model, limiting the introduction of artificial steric effects. The hydrogen of the hydroxyl remains relatively chemically benign% (low / neutral electronegativity)
 and it can be argued that it corresponds to polysaccharide chain endings. %what the heck does this really mean
