...
This is of particular importance when considering transition state searches and reaction-complex geometry optimisations. The exclusion of secondary non-bonding iteractions from the additional sites on larger models, and reduction in the degrees of freedom due to truncation of the model size, will simplify and speed-up structure searches. Thus the monomer model will be used for further studies involving single-site reaction mechanisms and transition state searching.
