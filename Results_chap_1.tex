...
\caption{\added{Bulk cellulose fibres are constructed from many linear strands of cellulose polymer, inter-linked by hydrogen bonds. The intermolecular bonding structure between multiple strands influence degradation properties by altering the crystallinity and solvent porosity of the bulk material. } \cite{Dumanli2017}. \added{Reproduced with permission from the authors.}}
\label{fig:fibre}
\end{figure}
