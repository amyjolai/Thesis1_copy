...
Topology analysis on dimers with lower levels of nitration (\acs{DOS}=2) show an interaction between unsubstituted hydroxyl side chains with the capping group on ring 1 (figure \ref{fig:2_0}). \ac{NC} dimers nitrated at only the R1C2 position exhibit H-bonding and H-H interaction between the capping group hydrogens and those of C6, and O-O interactions between R1O1 and hydroxyl oxygens at R2C3. %and C6 in the case of CH3CH3 and CH3OH dimers. 
