...
\begin{table}[htp]
\begin{center}
\caption{Topology analysis of dimers with capping groups. * Only present in \ac{CH3CH3} and \ac{CH3OH}; ** Only present in \ac{CH3CH3}; *** Intramolecular steric centres located between R1 and R2, and between nitrate groups and nearest $\alpha$-hydrogen on the glucopyranose ring.}
