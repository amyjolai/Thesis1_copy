...
A wide range of reaction products are experimentally observed during the low temperature decomposition and slow ageing of \ac{NC}. Small gaseous species such as \ce{CO2}, \ce{CO}, \ce{CH2O}, \ce{N2O}, \ce{NO2} are identified using IR spectroscopy, whilst the presence of larger species such as glycolic acid and oxalate are %alluded to ..spectra
suggested by analysis of the complex reaction mixture \cite{Jin2015,Bluhm1977}.
...
Fully nitrated dimers (\acs{DOS}=3) were bi-capped with methoxy (\acs{CH3CH3}), methoxy-hydroxy (\acs{CH3OH}) or hydroxy-methoxy (\acs{OHCH3}) groups at C1 and C4 positions (figure \ref{fig:capping-groups-all}).
...
where the arrangement of the side chains formed a pseudo cage-like environment  (table \ref{tab:table_cp}).  %any significance?
...
The \ac{ESP} maps % for the bi-capped methoxy dimer (\ac{CH3CH3}), methoxy-hydroxy capped dimer (\acs{CH3OH}) and hydroxy-methoxy capped dimer (\acs{OHCH3}) 
...
The terminal oxygen - $\alpha$-hydrogen interaction at the C2 nitrate was observed, as was seen in the fully nitrated systems (figure \ref{fig:monomer_top}).
